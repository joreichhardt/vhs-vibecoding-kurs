...
- ein eigenes Programm weiterentwickeln
...
Ergebnis: Alle Teilnehmenden haben eine eingerichtete Arbeitsumgebung und ein erstes Programm im Browser geoeffnet.
...
Diese Themen koennen je nach Gruppe angerissen werden, sind aber keine Voraussetzung fuer den Kurserfolg:

- Docker
- eigenes Server-Hosting
- VPS oder Cloud-Instanz
- Domains und HTTPS
- Datenbanken
- GitHub-Zusammenarbeit im Team
- groessere produktive Anwendungen
