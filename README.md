...
- Mitmach-Workshop
- 5 Termine von Dienstag bis Samstag
...
- Bereitschaft, Fehlermeldungen gemeinsam zu lesen
- keine sensiblen persoenlichen Daten fuer Uebungen verwenden
...
- Keine Passwoerter, Ausweisdaten, Kundendaten oder privaten Dokumente in KI-Tools eingeben.
...
- [KI-Grenzen und Qualitaetskontrolle](themen/grenzen-und-qualitaetskontrolle.md)
- [Deployment: Server, VPS und Cloud-Instanz](themen/deployment-server-vps-cloud.md)
- [Weiterlernen nach dem Kurs](themen/weiterlernen.md)
- [Fun Facts zu KI und Coding](themen/fun-facts.md)

## Vorlaeufiger Ablauf fuer 5 Termine
...
Ergebnis: Jede Person hat eine eingerichtete Arbeitsumgebung und ein erstes lauffaehiges Beispiel.
...
### Freitag, 18:00 bis 21:00 Uhr: Git, Struktur und Deployment-Vorbereitung
...
Ergebnis: Das Projekt ist aufgeraeumt, gesichert und bereit fuer Fertigstellung oder Veroeffentlichung.

### Samstag, 09:00 bis 15:00 Uhr: Eigenes Projekt fertigstellen

- individuelles Arbeiten am eigenen Projekt
- groessere Verbesserung oder Zusatzfunktion umsetzen
...
- optionaler Ausblick: Docker, Domains, HTTPS und Betrieb
- Ergebnisse gegenseitig ausprobieren
- kurze Abschlussrunde: Was funktioniert, was waere der naechste Schritt?
...
## Hinweis zum Kurs-Repository

Dieses Verzeichnis ist als oeffentliches Kurs-Repository gedacht, damit Teilnehmerinnen und Teilnehmer Materialien, Links und Beispielprojekte leicht abrufen koennen.
